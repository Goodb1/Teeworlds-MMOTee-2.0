#ifndef GAME_SERVER_CORE_ENTITIES_CASINO_DICE_LASER_H
#define GAME_SERVER_CORE_ENTITIES_CASINO_DICE_LASER_H
...
#endif // GAME_SERVER_CORE_ENTITIES_CASINO_DICE_LASER_H